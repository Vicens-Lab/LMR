...
class MetricsLogger:
    ...
    def _init_train_csv(self):
        ...
        with open(self.train_csv, 'w', newline='') as f:
            ...
            writer.writerow([
                ...
                'throughput_it_per_s', 'gpu_memory_mb', 'timestamp'
            ])
    ...
    def save_summary(
        ...
        with open(self.summary_txt, 'w') as f:
            ...
            f.write(f"  Average throughput: {total_steps/total_time:.2f} steps/sec\n")
            f.write("\n")
    ...
    def get_best_metrics(self) -> Dict:
        ...
        Returns:
            Dictionary with best validation loss and accuracy
        """
